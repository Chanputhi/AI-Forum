...
import {createArticleDocFromPost, firestoreDB , storage} from './utils/firebase';
...
const Article =() => {
    ...
    //     const imageStorageRef = ref(storage, `images/${article.image.name + v4()}`);
    //     uploadBytes(imageStorageRef, article.image).then
    //     (
    //         (snapshot) => {
    //             let progress;
    ...
    //     try {
    //         // console.log("Image URL  here:", img);
    //         console.log("Article Image here:", article.image);
    //         console.log("Article Image Name here:", article.image.name);
    ...
    const handleImageUpload = (e) => {
        ...
        // const imageStorageRef = ref(storage, `images/${imageUpload.name + v4()}`);
    ...
    return (
        <div className='articleDiv'>
            ...
            {/* <ImageUpload 
            onChange = { (e) => setArticle((preValue)=>({...preValue, image : e.target.image}) ) }
